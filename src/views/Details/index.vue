<script setup>
import {getgoodsdetail} from '@/apis/details.js'
      ...
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
                <img-view :imageList='detail.mainPictures'></img-view>
              <!-- 统计数量 -->
            ...
            <div class="spec">
              ...
              <!-- sku组件 -->
                <xtx-sku :goods=detail @change=skuchange></xtx-sku>
              <!-- 数据组件 -->
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                    <img v-for='item in detail.details?.pictures' :key="item" v-imglazy=item alt="">
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
